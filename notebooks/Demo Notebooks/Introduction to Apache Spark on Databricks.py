...
# MAGIC 
# MAGIC Click the Clusters button that you'll notice on the left side of the page. On the Clusters page, click on ![img]
# MAGIC 
# MAGIC Enter Cluster Details, 
# MAGIC 
...
# MAGIC -   Select whether to use a Serverless Pool (Beta) or a dedicated cluter.
